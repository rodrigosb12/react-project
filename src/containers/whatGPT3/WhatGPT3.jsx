  ...
  return (
    <div className='gpt3__whatgpt3 section__margin' id='wgpt3'>
      <div className='gpt3__whatgpt3-feature'>
        <Feature title='What is GPT-3' text={textGpt3} />
      </div>
      ...
      <div className='gpt3__whatgpt3-container'>
        ...
        <Feature title='Knowledgebase' text={textKnowledgebase} />
        <Feature title='Education' text={textEducation} />
      </div>
    </div>
  );
}
